    ...
    <header className="p-6 flex justify-between items-center max-w-7xl w-full mx-auto">
      <div className="container flex items-center justify-between">
        <a href="/" className="flex items-center gap-2">
          <span className="text-3xl font-bold">nexxode</span>
        </a>
        <nav>
          <ul className="flex items-center justify-end space-x-2.5 md:top-[1.125rem] lg:right-12 lg:top-[1.625rem]">
            <li role="presentation">
              <a
                rel="noopener noreferrer nofollow"
                className="inline-flex items-center justify-center w-11 h-11"
                target="_blank"
                href="https://github.com/nexxode"
              >
                <svg
